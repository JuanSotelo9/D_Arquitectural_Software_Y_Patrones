...
public class SearchManager extends JFrame {
  ...
  public static final String HEADHUNTE_REG = "Headhunter Enterprise SQL Statement";
  ...
  public SearchManager() throws Exception {
    ...
    cmbSearchType.addItem(SearchManager.HEADHUNTE_REG);
...
class BuilderFactory {
  public UIBuilder getUIBuilder(String str) {
    ...
    }else if (str.equals(SearchManager.HEADHUNTE_REG)){
      builder = new HdHntrRegBuilder();
    }
    return builder;
  }
}
